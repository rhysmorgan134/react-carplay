...
if getconf LONG_BIT | grep -q '64'; then
	echo "64 Bit Detected"
 	curl -L https://github.com/rhysmorgan134/react-carplay/releases/download/v4.0.6/react-carplay-4.0.6-arm64.AppImage --output /home/$USER/Desktop/Carplay.AppImage
else
